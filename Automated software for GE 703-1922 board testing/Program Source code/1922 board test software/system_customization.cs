...
{
    public partial class system_customization : Form
    {
        string USER = LOGIN_LOGIC.sendtext;
        string SERIAL = serial_logic.sendserial;
        public system_customization()
        {
            InitializeComponent();
        }
        ...
        {
            factory_default_settings P = new factory_default_settings();
            this.Hide();
            P.ShowDialog();
        }
