...
{
    public partial class Serial_port_configuration : Form
    {
        string USER = LOGIN_LOGIC.sendtext;
        string SERIAL = serial_logic.sendserial;
        public Serial_port_configuration()
        {
            InitializeComponent();
        }
        ...
        {
            serialport_configuration_confirmation P = new serialport_configuration_confirmation();
            this.Hide();
            P.ShowDialog();
        }
