...
{
    public partial class opertor_window_conifrmation : Form
    {
        string USER = LOGIN_LOGIC.sendtext;
        string SERIAL = serial_logic.sendserial;
        public opertor_window_conifrmation()
        {
            InitializeComponent();
        }
        ...
        {
            Serial_port_configuration P = new Serial_port_configuration();
            this.Hide();
            P.ShowDialog();
        }
