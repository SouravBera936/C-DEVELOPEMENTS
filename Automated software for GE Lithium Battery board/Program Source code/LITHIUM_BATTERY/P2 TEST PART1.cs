...
{
    public partial class P2_TEST_PART1 : Form
    {
        ...
        public static string sendtest5 = "";
        public static string sendtest6 = "";
        private void button3_Click(object sender, EventArgs e)
        {
         P6_TEST PART = new P6_TEST();
            this.Hide();
          PART.ShowDialog();
        }
        ...
        private void next_step_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                xlWorkSheet.Cells[11, 6] = sendtest5;
                xlWorkSheet.Cells[11, 7] = sendtest6;
        ...
        private void start_logic_Click(object sender, EventArgs e)
        {
            ...
            sendtest5 = Convert.ToString(test1);
        ...
        private void trip_current_TextChanged(object sender, EventArgs e)
        {

        }

        private void trip_voltage_TextChanged(object sender, EventArgs e)
        {
