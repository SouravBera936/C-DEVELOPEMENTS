...
{
    public partial class Microprocessor_test_screenshot : Form
    {
        ...
        public Microprocessor_test_screenshot()
        {
            InitializeComponent();  
        }
        ...
        private void PASSLOGIC_Click(object sender, EventArgs e)
        {
            ...
            captureBitmap.Save(@"D:\Resources\Report\TOSA MMB FUNCTIONAL TEST\REPORTS\" + folder_name + "\\" + "Microprocessor(BOOTME)_Test" + ".jpg", ImageFormat.Jpeg);
            Thread.Sleep(100);
            ...
            Microprocessor_Test2 main = new Microprocessor_Test2();
            this.Hide();
            main.ShowDialog();
        }
