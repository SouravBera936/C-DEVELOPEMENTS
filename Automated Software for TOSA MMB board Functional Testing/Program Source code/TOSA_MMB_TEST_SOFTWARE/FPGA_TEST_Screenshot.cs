...
{
    public partial class FPGA_TEST_Screenshot : Form
    {
        ...
        private void PASSLOGIC_Click(object sender, EventArgs e)
        {
            ...
            Bitmap captureBitmap = new Bitmap(2560, 1080, PixelFormat.Format32bppArgb);
            Rectangle captureRectangle = Screen.AllScreens[0].Bounds;
            Graphics captureGraphics = Graphics.FromImage(captureBitmap);
            captureGraphics.CopyFromScreen(captureRectangle.Left, captureRectangle.Top, 0, 0, captureRectangle.Size);
            captureBitmap.Save(@"D:\Resources\Report\TOSA MMB FUNCTIONAL TEST\REPORTS\" + folder_name + "\\" + "FPGA_Test" + ".jpg", ImageFormat.Jpeg);
...

            {
                ...
                if (p.ProcessName == "quartus_pgmw.exe")
            ...
            Thread.Sleep(500);
            e3649a1.Close();
            Erase_Memory_Test main = new Erase_Memory_Test();
            this.Hide();
            main.ShowDialog();
        }
