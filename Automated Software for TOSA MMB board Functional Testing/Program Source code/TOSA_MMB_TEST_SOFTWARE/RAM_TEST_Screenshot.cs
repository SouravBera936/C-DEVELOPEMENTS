...
{
    public partial class RAM_TEST_Screenshot : Form
    {
        ...
        public RAM_TEST_Screenshot()
        {
            InitializeComponent();
        }

        private void RAM_TEST_Screenshot_Load(object sender, EventArgs e)
        {
        ...
        private void PASSLOGIC_Click(object sender, EventArgs e)
        {
            ...
            captureBitmap.Save(@"D:\Resources\Report\TOSA MMB FUNCTIONAL TEST\REPORTS\" + folder_name + "\\" + "RAM_Test" + ".jpg", ImageFormat.Jpeg);
            ...
            Thread.Sleep(100);
            PLL_frequency_Test main = new PLL_frequency_Test();
            this.Hide();
            main.ShowDialog();
        }
