...
{
    public partial class Ethernet_Test_Screenshot : Form
    {
        ...
        public Ethernet_Test_Screenshot()
        {
            InitializeComponent();
        }
        ...
        private void PASSLOGIC_Click(object sender, EventArgs e)
        {
            ...
            captureBitmap.Save(@"D:\Resources\Report\TOSA MMB FUNCTIONAL TEST\REPORTS\" + folder_name + "\\" + "Ethernet_Test" + ".jpg", ImageFormat.Jpeg);
