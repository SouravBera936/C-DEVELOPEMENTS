...
{
    public partial class Microprocessor_Test3_Screenshot : Form
    {
        ...
        public Microprocessor_Test3_Screenshot()
        {
            InitializeComponent();
        }
        ...
        private void PASSLOGIC_Click(object sender, EventArgs e)
        {
            ...
            captureBitmap.Save(@"D:\Resources\Report\TOSA MMB FUNCTIONAL TEST\REPORTS\" + folder_name + "\\" + "Microprocessor3_Test" + ".jpg", ImageFormat.Jpeg);
        ...
        private void FAILLOGIC_Click(object sender, EventArgs e)
        {
            ...
            xlWorkbook.SaveAs(@"D:\Resources\Report\TOSA MMB FUNCTIONAL TEST\REPORTS\" + folder_name + filename);
            Thread.Sleep(100);
            foreach (Process p in Process.GetProcesses())
