...
{
    public partial class ARINC_BOARD_OPTICAL_TEST_VERIFICATION_4 : Form
    {
       ...
       // string folder_name = ARINC_OPTICAL_CABLE_TEST.send_folder_name;
        ...
        public ARINC_BOARD_OPTICAL_TEST_VERIFICATION_4()
        {
            InitializeComponent();
        }

        public static string send_report4 = "";
        ...
        private void SUBMIT_Click(object sender, EventArgs e)
        {
            ...
            send_report4 = LOG_PATH.Text;

            //richTextBox1.Text = text.ToString();
            if (text.ToString().Contains("Fail"))
            {
                MessageBox.Show("4th Optical fiber check Failed");
                string STATUS = "4th Optical fiber check Failed";
                string RESULT = "FAIL";
            ...
            {
                MessageBox.Show("4th Optical fiber check Passed");
                MessageBox.Show("Connect 5th Optical cable");
                ARINC_BOARD_OPTICAL_TEST_VERIFICATION_5 main = new ARINC_BOARD_OPTICAL_TEST_VERIFICATION_5();
                this.Hide();
                main.ShowDialog();
