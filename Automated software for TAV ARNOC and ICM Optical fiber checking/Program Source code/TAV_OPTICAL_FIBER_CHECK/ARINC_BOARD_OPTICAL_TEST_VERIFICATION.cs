...
namespace TAV_OPTICAL_FIBER_CHECK
{
    ...
    public partial class ARINC_BOARD_OPTICAL_TEST_VERIFICATION : Form
    {
        //string folder_name;
       ...
       // string folder_name = ARINC_OPTICAL_CABLE_TEST.send_folder_name;
        ...
        public ARINC_BOARD_OPTICAL_TEST_VERIFICATION()
        {
            InitializeComponent();
        ...
        public static string send_report1 = "";
        ...
        private void SUBMIT_Click(object sender, EventArgs e)
        {
            ...
            send_report1 = LOG_PATH.Text;

            //richTextBox1.Text = text.ToString();
            if (text.ToString().Contains("Fail"))
            {
               
                MessageBox.Show("1st Optical fiber check Failed");
                string STATUS = "1st Optical fiber check Failed";
                string RESULT = "FAIL";
            ...
            else
            {
                ...
                MessageBox.Show("Connect 2nd Optical cable ");
                ARINC_BOARD_OPTICAL_TEST_VERIFICATION_2 main = new ARINC_BOARD_OPTICAL_TEST_VERIFICATION_2();
                this.Hide();
                main.ShowDialog();
