...
{
    public partial class ARINC_BOARD_OPTICAL_TEST_VERIFICATION_5 : Form
    {
      ...
      //  string folder_name = ARINC_OPTICAL_CABLE_TEST.send_folder_name;
        ...
        public ARINC_BOARD_OPTICAL_TEST_VERIFICATION_5()
        {
            InitializeComponent();
        }

        public static string send_report5 = "";
        ...
        private void SUBMIT_Click(object sender, EventArgs e)
        {
            ...
            send_report5 = LOG_PATH.Text;

            //richTextBox1.Text = text.ToString();
            if (text.ToString().Contains("Fail"))
            {
                MessageBox.Show("5th Optical fiber check Failed");
                string STATUS = "5th Optical fiber check Failed";
                string RESULT = "FAIL";
            ...
            {
                MessageBox.Show("5th Optical fiber check Passed");
                MessageBox.Show("Connect 6th Optical Cable");
                ARINC_BOARD_OPTICAL_TEST_VERIFICATION_6 main = new ARINC_BOARD_OPTICAL_TEST_VERIFICATION_6();
                this.Hide();
                main.ShowDialog();
