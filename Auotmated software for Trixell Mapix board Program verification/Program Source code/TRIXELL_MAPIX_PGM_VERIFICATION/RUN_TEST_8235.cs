...
namespace TRIXELL_MAPIX_PGM_VERIFICATION
{
    ...
    public partial class RUN_TEST_8235 : Form
    {
        AgilentE36xx e3649a1 = new AgilentE36xx();
        public RUN_TEST_8235()
        {
            InitializeComponent();
        }
        ...
        private void SUBMIT_Click(object sender, EventArgs e)
        {
            ...
            {
                RUN_TEST2_8235 main = new RUN_TEST2_8235();
                this.Hide();
                main.ShowDialog();
            }
        }
        ...
        private void SUBMIT_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                System.IO.Directory.CreateDirectory("D:\\Resources\\Report\\TRIXELL MAPIX-8235 ONLINE PROGRAMMING VERIFICATION\\" + foldername);
                Thread.Sleep(100);
