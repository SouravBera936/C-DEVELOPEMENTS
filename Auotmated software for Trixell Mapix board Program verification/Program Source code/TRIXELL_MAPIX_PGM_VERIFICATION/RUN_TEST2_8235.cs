...
{
    public partial class RUN_TEST2_8235 : Form
    {
        AgilentE36xx e3649a1 = new AgilentE36xx();
        string SERIAL1 = RUN_TEST_8235.send_SERIAL;
        string folder_name = RUN_TEST_8235.send_folder_name;
        string USER = RUN_TEST_8235.send_operator_name;
        ...
        private void PASSLOGIC_Click(object sender, EventArgs e)
        {
            ...
            captureBitmap.Save(@"D:\Resources\Report\TRIXELL MAPIX-8235 ONLINE PROGRAMMING VERIFICATION\" + folder_name + "\\" + SERIAL1 + ".jpg", ImageFormat.Jpeg);
            //REPORT GENERATION
            ...
            string reporttemplatefilepath = @"D:\Resources\Report\TRIXELL MAPIX-8235 ONLINE PROGRAMMING VERIFICATION\Test Report.xml";
            ...
            System.IO.StreamWriter swExtLogFile = new System.IO.StreamWriter(@"D:\Resources\Report\TRIXELL MAPIX-8235 ONLINE PROGRAMMING VERIFICATION\" + folder_name + "\\" + filename, true);
           ...
           // }
            Thread.Sleep(200);
            RUN_TEST_8235 main = new RUN_TEST_8235();
            this.Hide();
            main.ShowDialog();
        }
